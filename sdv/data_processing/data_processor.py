...
class DataProcessor:
    ...
    def _fit_formatters(self, data):
        ...
        for column_name in data:
            ...
            sdtype = column_metadata.get('sdtype')
            if sdtype == 'numerical' and column_name != self._primary_key: #$ categorical sdtype ignored
    ...
    def prepare_for_fitting(self, data):
        ...
        if not self._prepared_for_fitting:
            ...
            if not config.get('sdtypes'):
                ...
                self._hyper_transformer.set_config(config)  #$ synthesizer.get_transformers() will become valid
